...
class SecurityHeadersMiddleware:
    ...
    def __call__(self, request):
        ...
        response['Content-Security-Policy'] = (
            ...
            f"  https://pagead2.googlesyndication.com https://*.googlesyndication.com "
            f"  https://googleads.g.doubleclick.net https://*.doubleclick.net "
            f"  https://tpc.googlesyndication.com https://www.googletagservices.com; "
            ...
            f"  https://*.googlesyndication.com https://*.doubleclick.net "
            f"  https://*.google.com https://*.gstatic.com; "
            f"connect-src 'self' https://static.osb.pf https://secure.osb.pf "
            f"  https://*.googlesyndication.com https://*.doubleclick.net "
            f"  https://*.google.com https://pagead2.googlesyndication.com; "
